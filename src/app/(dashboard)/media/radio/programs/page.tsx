...
const mockPrograms: Program[] = [
  { id: '1', name: 'Morning Show', stationId: '1', stationType: 'radio', schedule: 'Mon-Fri 6:00-9:00 AM', isActive: true },
  { id: '2', name: 'Drive Time', stationId: '1', stationType: 'radio', schedule: 'Mon-Fri 4:00-7:00 PM', isActive: true },
  { id: '3', name: 'Weekend Vibes', stationId: '2', stationType: 'radio', schedule: 'Sat-Sun 10:00 AM-2:00 PM', isActive: true },
]
...
export default function RadioProgramsPage() {
  ...
  const FormContent = () => (
    <div className="space-y-4">
      ...
      <div><Label>Schedule</Label><Input value={formData.schedule} onChange={(e) => setFormData({ ...formData, schedule: e.target.value })} placeholder="e.g., Mon-Fri 6:00-9:00 AM" /></div>
      <div className="flex items-center gap-2">
  ...
  return (
    <div className="p-6">
      ...
      <FormModal isOpen={createModal.isOpen} onClose={createModal.close} title="Add Radio Program" onSubmit={handleCreate} isSubmitting={false}><FormContent /></FormModal>
      <FormModal isOpen={editModal.isOpen} onClose={editModal.close} title="Edit Radio Program" onSubmit={handleEdit} isSubmitting={false}><FormContent /></FormModal>
