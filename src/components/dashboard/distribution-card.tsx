...
export function DistributionCard({ items, total }: DistributionCardProps) {
  ...
  const scaleMax = Math.ceil(maxPercentage / 10) * 10
  ...
  return (
    <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-soft border border-gray-100 h-full">
      ...
      <div className="flex mt-3 sm:mt-4 pl-[88px] sm:pl-28">
        <div className="flex-1 flex justify-between text-[10px] sm:text-xs text-gray-400">
          <span>0</span>
